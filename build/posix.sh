...
mkdir ${DEPS}/pdfium
$CURL https://github.com/bblanchon/pdfium-binaries/releases/download/chromium%2F${VERSION_PDFIUM}/pdfium-$(echo "$PLATFORM" | sed -E 's/musl/-musl/g; s/v[6-8]//g; s/darwin/mac/g; s/osx-//g').tgz | tar xfC ${TARGET} --strip-components=1
cd ${DEPS}/pdfium
